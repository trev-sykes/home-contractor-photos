        ...
        <div className="page">
            <div className="max-w-6xl mx-auto space-y-5 sm:space-y-6">
                ...
                <div>
                    ...
                    <h1 className="font-display text-3xl sm:text-4xl font-extrabold text-slate-900">Photos</h1>
                ...
                {photos.length > 0 && (
                    <div className="flex flex-col gap-3">
                        ...
                        {/* Filter tabs — full width grid so they never overflow */}
                                ...
                                <div className="flex items-center justify-between mb-3 sm:mb-4">
                                    <div className="min-w-0">
                                        <Link
                                            ...
                                            className="font-bold text-slate-800 hover:text-amber-600 transition truncate block"
                                        >
                                            {project.name}
                                        </Link>
                                        <p className="flex items-center gap-1.5 text-xs text-slate-400 mt-0.5">
                                            ...
                                            <span className="flex-shrink-0">{groupPhotos.length} photo{groupPhotos.length !== 1 ? "s" : ""}</span>
                                        </p>
                                    </div>
                                    <Link
                                        href={`/customers/${project.customer.id}/projects/${project.id}`}
                                        className="hidden sm:flex items-center gap-1.5 text-xs font-semibold transition hover:opacity-70 flex-shrink-0 ml-4"
            ...
            {lightbox && (
                ...
                >
                    ...
                    >
                        ...
                        {/* Info bar */}
                        <div
                            className="absolute bottom-0 left-0 right-0 rounded-b-xl sm:rounded-b-2xl px-4 sm:px-6 py-4 sm:py-5"
                        ...
                        >
                            ...
                            <p className="text-white/60 text-xs sm:text-sm truncate">
                                {lightbox.project.customer.name}
                            </p>
                        </div>
                        ...
                        <button
                            onClick={() => setLightbox(null)}
                            className="absolute top-2 right-2 sm:top-3 sm:right-3 w-9 h-9 rounded-full flex items-center justify-center text-white transition"
